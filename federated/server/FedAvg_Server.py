...
from federated.client.FedAvg_Client import FedAvg_Client
    ...
    def federate(self):
        ...
        for rnd in tqdm(range(global_rounds), desc="Global Rounds"):
            ...
            for client_id in selected_clients:
                client = FedAvg_Client(client_id, self.train_dataset, self.test_dataset,
                ...
                updated_local_model_list.append(copy.deepcopy(updated_local_model))
