...
from federated.client.FedMultiModal_Client import FedMultiModal_Client
...
class FedMultiModal_Server:
    ...
    def run(self):
        print("=== Running FedMultiModal Server ===")
        self.federate()
        self.evaluate()
    ...
    def federate(self):
        ...
        for rnd in tqdm(range(global_rounds), desc="Global Rounds"):
            ...
            for client_id in selected_clients:
                client = FedMultiModal_Client(client_id, self.train_dataset, self.test_dataset,
