...
from federated.client.FedProx_Client import FedProx_Client
class FedProx_Server:
    def __init__(self, model, train_set, test_set, train_user_groups, test_user_groups,
                 user_mod_drop_dict, device, args):
        self.args = args
        self.device = device
    ...
    def federate(self):
        ...
        for rnd in tqdm(range(global_rounds), desc="Global Rounds"):
            ...
            for client_id in selected_clients:
                client = FedProx_Client(client_id, self.train_dataset, self.test_dataset,
