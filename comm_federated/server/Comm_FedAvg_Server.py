...
from comm_federated.client.Comm_FedAvg_Client import FedAvg_Client
import random
    ...
    def run(self):
        ...
        for epoch in tqdm(range(global_rounds)):
            ...
            for client_idx in selected_clients_in_current_round:
                cur_client = FedAvg_Client(copy.deepcopy(self.model), client_idx, self.device_dict[client_idx], self.args)
