...
from comm_federated.client.Comm_FLISM_Client import FLISM_Client
import random
    ...
    def run(self):
        ...
        for epoch in tqdm(range(global_rounds)):
            ...
            for client_idx in selected_clients_in_current_round:
                cur_client = FLISM_Client(copy.deepcopy(self.global_model), client_idx, self.device_dict[client_idx],
                                           self.args)
