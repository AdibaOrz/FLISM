...
class RealWorldHAR_Dynamic_Model(nn.Module):
    def __init__(self):
        super(RealWorldHAR_Dynamic_Model, self).__init__()

        self.num_modalities = RealWorldHAR_Opt['num_modalities']
        self.encoder = Dynamic_Encoder(self.num_modalities, RealWorldHAR_Opt['dim_lists'])
        self.classifier = Classifier(RealWorldHAR_Opt['num_classes'])
