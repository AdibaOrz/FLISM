...
class PAMAP2_Dynamic_Model(nn.Module):
    def __init__(self):
        super(PAMAP2_Dynamic_Model, self).__init__()

        self.num_modalities = PAMAP2_Opt['num_modalities']
        self.encoder = Dynamic_Encoder(self.num_modalities, PAMAP2_Opt['dim_lists'])
        self.classifier = Classifier(PAMAP2_Opt['num_classes'])
