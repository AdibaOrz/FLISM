...
class WESAD_Dynamic_Model(nn.Module):
    def __init__(self):
        super(WESAD_Dynamic_Model, self).__init__()

        self.num_modalities = WESAD_Opt['num_modalities']
        self.encoder = Dynamic_Encoder(self.num_modalities, WESAD_Opt['dim_lists'])
        self.classifier = Classifier(WESAD_Opt['num_classes'])
